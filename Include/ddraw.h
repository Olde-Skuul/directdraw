...
// For compilers that don't have SAL.h
...
// Supported on Visual Studio 2005 or higher
...
//#if defined( _WIN32 ) && !defined( _NO_ENUM )
    ...
    _Check_return_ HRESULT WINAPI DirectDrawEnumerateW( LPDDENUMCALLBACKW lpCallback, LPVOID lpContext );
    ...
    _Check_return_ HRESULT WINAPI DirectDrawCreateClipper( DWORD dwFlags, LPDIRECTDRAWCLIPPER FAR *lplpDDClipper, IUnknown FAR *pUnkOuter );
#endif
/*
